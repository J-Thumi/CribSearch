...
<div class="bg-bg min-h-screen py-12">
    ...
    <form action="{{ route('houses.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden hover:border-primary transition-all duration-300 group">
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center text-gray-500 text-sm mb-4">
                        <svg class="w-4 h-4 mr-2 text-accent flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd" />
                        </svg>
                        <span class="font-medium mr-2">{{ count($house->units) }} Unit Types:</span>
