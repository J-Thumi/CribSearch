                ...
                <div class="sticky top-28 space-y-6">
                    ...
                    <div class="bg-amber-500/5 p-6 sm:p-8 rounded-3xl border border-amber-500/20 relative overflow-hidden">
                       ...
                       @php
                            ...
                            $houseUrl = route('houses.show', $house);
                        ...
                        <a
                            href="https://wa.me/{{ $phone }}?text={{ urlencode(
                                'Hi, I am interested in ' . $house->name .
                                '. Here is the house listing: ' . $houseUrl
                            ) }}"
                            target="_blank"
                        ...
                        >
                            WhatsApp {{ $house->scout->name ?? 'our property scout' }} 
                        </a>
                    </div>
